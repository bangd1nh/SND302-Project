...
function AdminSideBar() {
  return (
    <aside
      id="default-sidebar"
      className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 mt-15 "
      aria-label="Sidebar"
    >
      <div className="my-5 h-full px-3 py-4 overflow-y-auto bg-gray-50">
        <ul className="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span className=" ms-3 whitespace-nowrap">Books</span>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            ...
            >
              ...
              <span className="ms-3 whitespace-nowrap">Author</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="ms-3 whitespace-nowrap">Statistic</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="ms-3 whitespace-nowrap">Borrow </span>
            </a>
          </li>
          <li>
            <a
